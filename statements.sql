...
-- Tu respuesta aquí
SELECT * FROM usuarios_lenguajes WHERE lenguaje LIKE 'javascript' AND edad < 25
-- Ejercicio 8 OPCION 2: Contar cuántos usuarios con edades diferentes saben el lenguaje 'Java'.
-- Tu respuesta aquí
SELECT  DISTINCT COUNT(*) FROM usuarios_lenguajes WHERE lenguaje 'javascript'
...
-- Tu respuesta aquí
SELECT lenguaje,COUNT(*) AS lenguaje_Top FROM usuarios_lenguajes WHERE edad < 30 ORDER by lenguaje_Top DESC LIMIT 1

-- Ejercicio 15: Seleccionar el usuario  mayor de 25 y que sepa el lenguaje 'TypeScript'.
-- Tu respuesta aquí
SELECT lenguaje,COUNT(*) AS lenguaje_Top FROM usuarios_lenguajes WHERE edad < 30 group by lenguaje order by lenguaje_Top DESC LIMIT 1
...
-- Tu respuesta aquí
SELECT nombre, apellido, edad, lenguaje FROM usuarios_lenguajes ORDER BY nombre;
...
SELECT COUNT(*) AS total_usuarios_css_menos_30 FROM usuarios_lenguajes WHERE lenguaje = 'CSS' AND edad < 30;


-- Ejercicio 21: Seleccionar los usuarios que tienen al menos un lenguaje asociado y mostrar la cantidad de lenguajes que tienen.
-- Tu respuesta aquí

SELECT *, COUNT(lenguaje) AS cantidad_lenguajes FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL GROUP BY nombre, apellido, edad;
...
SELECT COUNT(*) AS total_usuarios_apellido_g FROM usuarios_lenguajes WHERE apellido LIKE 'G%';
